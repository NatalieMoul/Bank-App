...
class TransactionService
{
    ...
    /**
     * Create a payment transaction for a bill/service payment or mobile top-up.
     */
    public function payment(Account $account, float $amount, string $service, string $reference): Transaction
    {
        ...
        try {
            ...
            $transaction = Transaction::create([
                ...
                'type' => 'payment',
                'amount' => $amount,
                'balance_after' => $freshAccount->balance,
                'status' => 'completed',
            ...
            $this->notificationService->notify(
                ...
                'transaction',
                'Payment successful',
                $service . ' payment of ' . number_format($amount, 2) . ' ' . $freshAccount->currency . ' was completed.',
                [
